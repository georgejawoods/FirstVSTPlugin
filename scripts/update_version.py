...
def main():
  ...
  plistpath = scriptpath + "/resources/MyNewPlugin-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MyNewPlugin-AU-Info.plist"
  with open(plistpath, 'rb') as fp:
    au = plistlib.load(fp)
  ...
  plistpath = scriptpath + "/resources/MyNewPlugin-VST3-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/MyNewPlugin-macOS-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/MyNewPlugin-AAX-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/installer/MyNewPlugin.pkgproj"
  with open(plistpath, 'rb') as fp:
  ...
  for line in fileinput.input(scriptpath + "/installer/MyNewPlugin.iss",inplace=1):
