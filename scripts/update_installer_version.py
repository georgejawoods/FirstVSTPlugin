...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=MyNewPlugin Demo Installer\n"
      else:
        line="OutputBaseFilename=MyNewPlugin Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the MyNewPlugin Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the MyNewPlugin installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=MyNewPlugin Demo installer\n"
     else:
       line="SetupWindowTitle=MyNewPlugin installer\n"
